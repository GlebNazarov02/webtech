...
$skills = [
  ['name' => 'Adobe Photoshop', 'percent' => 97],
  ['name' => 'Photo', 'percent' => 83],
  ['name' => 'Illustrator', 'percent' => 70],
  ['name' => 'Media', 'percent' => 80],
];
...
$workExperience = [
  [
    ...
    'description' => 'Делал внутреннюю и вычислительную логику веб-сайта или веб-приложенияte'
  ],
  [
    'jobTitle' => 'Back End Developer',
    'periodStart' => 'Mar 2012',
    'periodFinish' => 'Dec 2014',
    'description' => 'Создание баз данных и управляет ими, протзводил интеграции с внешними сервисами'
  ],
  [
    'jobTitle' => 'Graphic Designer',
    'periodStart' => 'Jun 2010',
    'periodFinish' => 'Mar 2012',
    'description' => 'create visual concepts, using computer software or by hand to communicate ideas that motivate, inform and enchant customers'
  ],
];
?>
